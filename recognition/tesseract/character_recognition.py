...
if __name__ == "__main__":
    ...
    image = cv2.imread("/home/vosar/Documents/CS@UCU/AI/CourseProject/datasets/dataset-real-plates-500-10000/data/0_AA0001CM_3.jpg")
    print(recognize_characters([image]))
