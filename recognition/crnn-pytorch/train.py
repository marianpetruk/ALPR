...
@click.option('--input-size', type=str, default="32x32", help='Input size')
...
def main(data_path, abc, seq_proj, backend, snapshot, input_size, base_lr, step_size, max_iter, batch_size, output_dir,
         epochs, test_epoch, test_init, gpu):
    ...
    transform = Compose([
        ...
        #GaussNoise(var_limit=(5, 25), p=0.1),
        Normalize(),
